...
public class ConcurrentArrayAppendPop {
    ...
    public int pop() {
        ...
        try {
            ...
            // at(s) could see tags as valid and read store[s], but that's just a stale read while
            // pop is performed. It does prevent writing to store[s] in primitive arrays, which is OK.
            // store[s] = NIL; // or not?
            tags[s] = false;
            return value;
        } finally {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final ConcurrentArrayAppendPop array = new ConcurrentArrayAppendPop();
